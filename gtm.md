...
| `runtime-telemetry`         | Explicit runtime adapter and opt-in browser events          | Spec 1      |
...
- We do not ship telemetry from `@threadplane/*` browser packages by default. Runtime telemetry is explicit opt-in in browsers and explicit capture in Node; see [libs/telemetry/README.md](libs/telemetry/README.md) for the full contract.
