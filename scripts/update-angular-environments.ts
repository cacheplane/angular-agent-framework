...
const capabilities = [
  ...
  { dir: 'cockpit/deep-agents/planning/angular', assistantId: 'da-planning', field: 'streamingAssistantId' },
  { dir: 'cockpit/deep-agents/filesystem/angular', assistantId: 'da-filesystem', field: 'streamingAssistantId' },
