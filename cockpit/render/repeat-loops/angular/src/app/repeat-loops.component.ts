    ...
    <example-split-layout>
      ...
      <div secondary class="flex flex-col h-full">
        ...
        <div class="shrink-0 border-t border-[var(--tplane-chat-separator)] p-4">
          <div class="text-[10px] text-[var(--tplane-chat-text-muted)] uppercase tracking-widest font-semibold mb-3">List Controls</div>
          <div class="space-y-3">
            <button
              ...
              <div class="space-y-1">
                @for (item of getItems(); track $index) {
                  <div class="flex items-center justify-between text-xs">
                    <span class="text-[var(--tplane-chat-text)] truncate">{{ item }}</span>
                    <button class="text-[var(--tplane-chat-text-muted)] hover:text-red-400 text-[10px] transition-colors"
