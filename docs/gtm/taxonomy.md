...
| `marketing:ai_crawler_visit`          | Edge middleware saw a known AI crawler UA on an HTML route. Props: `ai_crawler`, `source_page`, `user_agent`. Deduped per crawler/path/hour. |
