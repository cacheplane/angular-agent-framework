...
**Tech Stack:** Python 3.12 + uv + coverage.py for the trace pass; bash + ripgrep for the static pass; Playwright + `aimock` for fixture replay (existing infra at `examples/chat/angular/e2e/aimock-runner.ts`).
