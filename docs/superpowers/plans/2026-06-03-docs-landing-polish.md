...
test.describe('Docs landing page', () => {
  test('renders the start-here funnel + search prompt', async ({ page }) => {
    ...
    await expect(page.locator('main img[src="/logos/runtimes/ag-ui.svg"]').first()).toBeVisible();
...
const BACKENDS: Backend[] = [
  ...
  },
  {
    ...
    logoSrc: '/logos/runtimes/ag-ui.svg',
    attribution: 'AG-UI',
  },
];
...
- [ ] Each fork card shows its vendor mark in a white chip + uppercase attribution (LangChain, AG-UI, Google, Vercel).
