...
**Hard constraint:** Never reference hashbrown / a competing React framework / chatgpt / chatbot-kit / claude in code, comments, commits, PR bodies, or docs. The architecture is independently arrived at.
