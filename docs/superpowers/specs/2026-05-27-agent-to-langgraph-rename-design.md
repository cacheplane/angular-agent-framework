...
- Decision matrix: backend type → adapter (LangGraph Platform → langgraph; AG-UI-protocol backend like CrewAI/Mastra/Agent Framework/AG2/Pydantic AI/AWS Strands/a competing React framework runtime → ag-ui)
