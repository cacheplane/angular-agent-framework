...
Research subagent surveyed LangChain/LangGraph, Vercel AI SDK, assistant-ui, a competing React framework/AG-UI, and the ChatGPT/Claude reference UX. Cross-cutting consensus:
