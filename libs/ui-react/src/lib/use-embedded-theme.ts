 ...
 * host theme, defaulting to `'dark'` until the first `tplane:theme` message
 * arrives. On mount, posts an `tplane:theme-request` to `window.parent` so
