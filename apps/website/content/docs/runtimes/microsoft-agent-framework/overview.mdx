...
The wire capture behind the design is committed next to the module as [`python/docs/wire-capture-subagents.md`](https://github.com/cacheplane/angular-agent-framework/blob/main/cockpit/runtimes/microsoft-agent-framework/python/docs/wire-capture-subagents.md).
