---
title: Skills
description: SkillsMiddleware loads only SKILL.md frontmatter into the prompt and leaves the body on disk, and skills_metadata is private state a panel must reach deliberately.
---
