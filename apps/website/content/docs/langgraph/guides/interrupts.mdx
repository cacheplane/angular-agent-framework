...
// createAgentRef accepts the BagTemplate as its second generic
export const TYPED_DEPLOY_AGENT = createAgentRef<DeployState, DeployBag>('approval_agent');

const agent = injectAgent(TYPED_DEPLOY_AGENT);
