...
See [`createAgentRef`](/docs/langgraph/api/create-agent-ref) for the full ref API, including the optional `BagTemplate` second generic for typed interrupt payloads.
