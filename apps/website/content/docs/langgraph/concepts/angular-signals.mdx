...
Every component using `injectAgent()` should use `ChangeDetectionStrategy.OnPush`. Here's why it works and why it's efficient.
...
<CardGroup cols={2}>
  ...
  <Card title="OnPush Guide" href="/docs/langgraph/concepts/angular-signals">
