...
export class ProjectComponent {
  protected readonly agent = injectAgent<ProjectState>();
}
```
...
export class ChatComponent {
  ...
  protected readonly agent = injectAgent<ChatState>();
...
// component.ts
const agent = injectAgent<ChatState>();
...
// provideAgent({ apiUrl: '...', assistantId: 'research_agent' });

// In your component:
protected readonly agent = injectAgent<ResearchState>();
```
