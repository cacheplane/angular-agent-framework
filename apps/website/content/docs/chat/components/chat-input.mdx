...
|-------|------|---------|-------------|
| `ref` | `LangGraphAgent<any, any>` | **Required** | The agent to submit messages to |
...
function sendGreeting(ref: LangGraphAgent<any, any>) {
...
|-----------|------|-------------|
| `ref` | `LangGraphAgent<any, any>` | The agent to submit to |
