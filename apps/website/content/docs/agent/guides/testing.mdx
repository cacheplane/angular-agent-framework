...
import { MockAgentTransport, agent } from '@cacheplane/langgraph';
import type { BaseMessage } from '@cacheplane/langgraph';
...
Make sure `@cacheplane/langgraph` is available in your test environment. MockAgentTransport ships with the main package — no extra install needed.
</Step>
