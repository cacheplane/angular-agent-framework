---
description: Setup guide for @threadplane/render in an Angular 20-22 application: install the package and its peers, configure provideRender(), and verify the first render.
---
