...
Ours was written down, which is the only reason I could check it.
Checking it is how I learned the deletion was a default two of our apps had already bought back — and that our first drift design was measuring the wrong thing.
