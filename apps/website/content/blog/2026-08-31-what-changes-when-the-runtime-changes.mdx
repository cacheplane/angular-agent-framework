...
*Three genuinely non-LangGraph backends, two languages, wire transcripts replayed through the shipped client — every surface in the table above, subagent delegation included.*
