    ...
    return {
      ...
      html: wrapEmail({
        body: `
          ...
          <p style="font-size:14px;color:#555770;line-height:1.7;margin:0 0 24px">Most teams spend 2–4 sprints building a chat UI before a single agent feature lands. Streaming state management, optimistic updates, thread history, error recovery — it's the same work every time. @threadplane/chat eliminates the sprint tax so your team ships features from day one.</p>
