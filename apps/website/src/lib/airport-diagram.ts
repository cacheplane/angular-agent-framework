...
export const NEAT = { x: 8, y: 8, width: 984, height: 488 } as const;
 ...
 */
export const OFF_AIRPORT_LABEL = 'All AI Models supported';
...
export const PROVIDER_ROW = { y: 562, size: 20, x0: 30, step: 76, labelY: 536 } as const;

/** Chart furniture lives in the margin, never on the field. */
export const SCALE_BAR = { x0: 742, x1: 842, y: 556 } as const;
export const NORTH = { x: 960, y: 542 } as const;
